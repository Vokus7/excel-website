    ...
    return (
        <div className='h-screen w-full'>
            <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-8 pt-40 md:flex-row">
                ...
                <div className="flex flex-col justify-center h-80 md:h-full">
                    <img src={HeroImage} alt="vector dental clinic" className="mx-10 my-5 md:my-5 w-full self-center h-80 md:h-full md:w-full" />
                </div>
            </div>
        </div>
    )
