...
const About = () => {
    return (
        <div name="about us" className='md:h-full h-fit md:mt-8 md:mb-48 w-full pt-16'>
            <div className='max-w-screen-lg px-4 mx-auto md:pt-0 flex flex-col justify-start items-center md:justify-center w-full h-full'>
                <div className='mt-2'>
                    <p className='text-3xl font-bold inline w-fit border-b-4 border-blue-400 leading-relaxed text-gray-900 mb-5 mx-10'>
                        About Us
                    </p>
                </div>
